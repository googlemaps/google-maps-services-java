...
public class PlacesApiTest {
  ...
  public void testPlaceDetailsLookupGoogleSydney() throws Exception {
    ...
    assertEquals(placeDetails.addressComponents[1].types[0], AddressType.STREET_NUMBER);
    ...
    assertEquals(placeDetails.addressComponents[2].types[0], AddressType.ROUTE);
    assertEquals(placeDetails.addressComponents[3].shortName, "Pyrmont");
    assertEquals(placeDetails.addressComponents[3].types[0], AddressType.LOCALITY);
    assertEquals(placeDetails.addressComponents[3].types[1], AddressType.POLITICAL);
    ...
    assertEquals(placeDetails.addressComponents[4].types[0], AddressType.ADMINISTRATIVE_AREA_LEVEL_1);
    assertEquals(placeDetails.addressComponents[4].types[1], AddressType.POLITICAL);
    ...
    assertEquals(placeDetails.addressComponents[5].types[0], AddressType.COUNTRY);
    assertEquals(placeDetails.addressComponents[5].types[1], AddressType.POLITICAL);
    assertEquals(placeDetails.addressComponents[6].shortName, "2009");
    assertEquals(placeDetails.addressComponents[6].types[0], AddressType.POSTAL_CODE);
